...
{global $twig, $mysql, $lang, $breadcrumb;
	...
	$tVars = array(
		'pagesss' => generateAdminPagelist( array(	'current' => $pageNo,
													'count' => $countPages,
													'url' => '?mod=extra-config&plugin=simple_title_pro&action=list_news&page=%page%'
													)
		),
		'entries' => $entries 
	);
...
{global $twig, $mysql, $lang, $breadcrumb;
	...
	$tVars = array(
		'pagesss' => generateAdminPagelist( array(	'current' => $pageNo,
													'count' => $countPages, 
													'url' => '?mod=extra-config&plugin=simple_title_pro&action=list_static&page=%page%'
												)
		),
		'entries' => $entries 
	);
...
{global $twig, $mysql, $lang, $breadcrumb;
	...
	$tVars = array(
		'pagesss' => generateAdminPagelist( array(	'current' => $pageNo,
													'count' => $countPages,
													'url' => '?mod=extra-config&plugin=simple_title_pro&action=list_cat&page=%page%'
													)
		),
		'entries' => $entries 
	);
