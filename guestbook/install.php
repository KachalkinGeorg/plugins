	...
	$db_update = array(
		array(
			...
			'fields' => array(
				...
				array('action' => 'create', 'name' => 'answer', 'type' => 'text', 'params' => "not null"),
				array('action' => 'create', 'name' => 'author', 'type' => 'varchar(50)', 'params' => "not null"),
				array('action' => 'create', 'name' => 'ip', 'type' => 'varchar(40)', 'params' => "not null"),
