<form method="post" action="?mod=extra-config&amp;plugin=gmanager&amp;action=general_submit">
	<fieldset>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td width="100%" colspan="2" class="contentEdit" align="center">
				<input type="button" onmousedown="javascript:window.location.href='?mod=extra-config&plugin=gmanager&action=clear_cash'" value="{l_gmanager:button_clear_cash}" class="button"/>&nbsp
