	...
	$db_update = array(
		array(
			...
			'fields' => array(
				...
				array('action' => 'cmodify', 'name' => 'id_icon', 'type' => 'int(11)', 'params' => 'NOT NULL DEFAULT "0"'),
				array('action' => 'cmodify', 'name' => 'order', 'type' => 'int(11)', 'params' => 'NOT NULL DEFAULT "0"'),
				array('action' => 'cmodify', 'name' => 'if_active', 'type' => 'int(1)', 'params' => 'NOT NULL DEFAULT "0"'),
				array('action' => 'cmodify', 'name' => 'name', 'type' => 'varchar(25)', 'params' => 'NOT NULL'),
				array('action' => 'cmodify', 'name' => 'title', 'type' => 'varchar(50)', 'params' => 'NOT NULL'),
