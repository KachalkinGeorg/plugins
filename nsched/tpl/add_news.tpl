...
<div class="input-group">
	<input type="text" placeholder="Дата включения..." name="nsched_activate" autocomplete="off" class="form-control" />
...
<div class="input-group">
	<input type="text" placeholder="Дата отключения..." name="nsched_deactivate" autocomplete="off" class="form-control" />
	<div class="input-group-append">
