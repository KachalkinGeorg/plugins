...
function show_options() {
	...
	global $tpl, $mysql, $lang, $twig, $breadcrumb;
	
	$breadcrumb = breadcrumb('<i class="fa fa-user btn-position"></i><span class="text-semibold">Social networks auth</span>', array('?mod=extras' => '<i class="fa fa-puzzle-piece btn-position"></i>'.$lang['extras'].'', '<i class="fa fa-user btn-position"></i>Social networks auth' ) );
