...
if (!getPluginStatusActive('tags')) {
	msg(['type' => 'error', 'text' => 'Для работы similar требуется ниличия плагина <strong>tags</strong>.']);
	return print_msg( 'warning', 'similar', 'Внимание!<br>Плагин <strong>tags</strong> не был установлен. Для использования этого дополнения, необходимо установить плагин <a href="?mod=extra-config&plugin=tags">tags</a>', '?mod=extras' );
}
