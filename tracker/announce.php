...
class TrackerNewsFilter extends NewsFilter {
	...
	function addNewsForm(&$tvars) {
        ...
        $tvars['extends'][$extends][] = [
			'title' => "Torrent трекер",
			'body' => $twig->render($tpath['news.add'].'/news.add.tpl', $ttvars),
			];
	...
	function editNewsForm($newsID, $SQLold, &$tvars) {
        ...
        $ttvars = array(
            'localPrefix' => localPrefix,
			'admin_url' => admin_url,
			'tracker_magnet' => secure_html($magnetLink),
            );
        ...
        $tvars['extends'][$extends][] = [
			'title' => "Torrent трекер",
			'body' => $twig->render($tpath['news.edit'].'/news.edit.tpl', $ttvars),
			];
