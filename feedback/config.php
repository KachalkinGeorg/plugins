...
function addForm()
{
	...
	$breadcrumb = breadcrumb('<i class="fa fa-fax btn-position"></i><span class="text-semibold">Feedback forms</span>', array('?mod=extras' => '<i class="fa fa-puzzle-piece btn-position"></i>'.$lang['extras'].'', '?mod=extra-config&plugin=feedback' => '<i class="fa fa-fax btn-position"></i>Feedback forms',  '<i class="fa fa-exclamation-circle btn-position"></i>Добавить форму' ) );
...
function showList()
{
    global $mysql, $lang, $breadcrumb, $twig;
	$breadcrumb = breadcrumb('<i class="fa fa-fax btn-position"></i><span class="text-semibold">Feedback forms</span>', array('?mod=extras' => '<i class="fa fa-puzzle-piece btn-position"></i>'.$lang['extras'].'', '?mod=extra-config&plugin=feedback' => '<i class="fa fa-fax btn-position"></i>Feedback forms',  '<i class="fa fa-exclamation-circle btn-position"></i>Список форм' ) );
    $tVars = [];
    $tForms = [];
...
function showForm(bool $edMode = false)
{
	...
	$breadcrumb = breadcrumb('<i class="fa fa-fax btn-position"></i><span class="text-semibold">Feedback forms</span>', array('?mod=extras' => '<i class="fa fa-puzzle-piece btn-position"></i>'.$lang['extras'].'', '?mod=extra-config&plugin=feedback' => '<i class="fa fa-fax btn-position"></i>Feedback forms',  'Редактирование '.$frow['name'].'' ) );
    // Unpack form data
...
{
    global $mysql, $lang, $twig, $breadcrumb;
	
	$breadcrumb = breadcrumb('<i class="fa fa-fax btn-position"></i><span class="text-semibold">Feedback forms</span>', array('?mod=extras' => '<i class="fa fa-puzzle-piece btn-position"></i>'.$lang['extras'].'', '?mod=extra-config&plugin=feedback' => '<i class="fa fa-fax btn-position"></i>Feedback forms',  '<i class="fa fa-exclamation-circle btn-position"></i>Поле формы' ) );
