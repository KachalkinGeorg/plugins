	...
	$db_update = array(
		array(
			...
			'fields' => array(
				...
				array('action' => 'cmodify', 'name' => 'author', 'type' => 'varchar(100)', 'params' => 'NOT NULL'),
		...
		array(
			...
			'fields' => array(
				array('action' => 'cmodify', 'name' => 'id_user', 'type' => 'int(11)', 'params' => 'NOT NULL'),
				array('action' => 'cmodify', 'name' => 'time', 'type' => 'int(10)', 'params' => 'NOT NULL'),
				array('action' => 'cmodify', 'name' => 'id_quotes', 'type' => 'int(11)', 'params' => 'NOT NULL'),
			)
		)
	);
	$ULIB = new urlLibrary();
