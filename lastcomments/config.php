...
if (!getPluginStatusActive('comments')) {
	msg(['type' => 'error', 'text' => 'Для работы lastcomments требуется ниличия плагина <strong>comments</strong>.']);
	return print_msg( 'warning', 'lastcomments', 'Внимание!<br>Плагин <strong>comments</strong> не был установлен. Для использования этого дополнения, необходимо установить плагин <a href="?mod=extra-config&plugin=comments">comments</a>', '?mod=extras' );
}
