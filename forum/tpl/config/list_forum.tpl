<tr align="center" class="contRow1">
	...
	<td>	
		...
		<a class="btn btn-outline-primary" href="?mod=extra-config&plugin=forum&action=edit_section&id={{ forum_id }}" title="Редактировать"><i style="vertical-align: bottom;" class="fa fa-pencil"></i></a>
		...
		<a class="btn btn-outline-info" href="?mod=extra-config&plugin=forum&action=send_forum&id={{ forum_id }}" title="добавить подраздел">
