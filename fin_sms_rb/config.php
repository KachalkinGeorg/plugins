...
if (!getPluginStatusActive('finance')) {
	msg(['type' => 'error', 'text' => 'Для работы Russian Billing требуется ниличия плагина <strong>finance</strong>.']);
	return print_msg( 'warning', 'SMS :: Russian Billing', 'Внимание!<br>Плагин <strong>finance</strong> не был установлен. Для использования этого дополнения, необходимо установить плагин <a href="?mod=extra-config&plugin=finance">finance</a>', '?mod=extras' );
}
